...
#include "AnimNotifies/ScWAnimNotify_NiagaraSystem_IfVisible.h"
...
{
	if (UScWUtilsFunctionLibrary::IsComponentRenderedFor(InMeshComponent, InMeshComponent->GetOwner()))
	{
